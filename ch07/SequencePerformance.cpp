...
// Compare the performance of the basic
// sequence containers for various perations
...
struct InsertBack {
	...
	const char* testName() { return "InsertBack"; }
};
...
struct InsertFront {
	...
	const char* testName() { return "InsertFront"; }
};
...
struct InsertMiddle {
	...
	const char* testName() { return "InsertMiddle"; }
};
...
struct RandomAccess {	// Not for list
	...
	const char* testName() { return "RandomAccess"; }
};
...
struct Traversal {
	...
	const char* testName() { return "Traversal"; }
};
...
struct Swap {
	...
	const char* testName() { return "Swap"; }
};
...
struct RemoveMiddle {
	...
	const char* testName() { return "RemoveMiddle"; }
};
...
struct RemoveBack {
	...
	const char* testName() { return "RemoveBack"; }
};
...
void measureTime(Op f, Container& c, long count) {
	...
	string cont = Deque ? "deque" : List ? "list" : Vector ? "vector" : "unknown";
